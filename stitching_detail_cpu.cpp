...
#ifdef HAVE_OPENCV_XFEATURES2D1
...
string result_name = "D:\\image_data\\result.jpg";
...
static int parseCmdArgs(int argc, char** argv)
{
    ...
    cout << "try_cuda:'" << try_cuda << "'\n";
    cout << "cuda::getCudaEnabledDeviceCount():'" << cuda::getCudaEnabledDeviceCount() << "'\n";
    if (argc == 1)
    {
        printUsage(argv);
        return -1;
